...
function CguContent() {
    return (
        <>
            ...
            <a href="http://www.tracer-o.fr">www.tracer-o.fr</a> sont :
            ...
            Stéphane LAVAUD Numéro de SIRET : 85294960100011 Responsable
            editorial : Olivier RECARD 7 quater Impasse Piquessary Téléphone
            :0680040731 - Email : recart-olivier@tracer-o.fr Site Web :{" "}
            <a href="http://www.tracer-o.fr">www.tracer-o.fr</a>
            <p style={{ color: "#b51a00" }}>
                <b>
                    <h3>
                        <b>
            ...
            Hébergeur : Netlify, Inc. 2325 3rd Street, Suite 215, San Francisco,
            California 94107 Site Web :{" "}
            <a href="http://www.netlify.com">www.netlify.com</a>
            <p style={{ color: "#b51a00" }}>
                <h3>
                    <span style={{ color: "rgb(0, 0, 0)" }}>
                        <b>Développement :</b>
            ...
            Stéphane LAVAUD - Site Web :{" "}
            <a href="http://www.stephane-lavaud.dev">www.stephane-lavaud.dev</a>
            <p style={{ color: "#b51a00" }}>
            ...
            Ce site (<a href="http://www.tracer-o.fr">www.tracer-o.fr</a>) est
            ...
            modernes comme Safari, Firefox, Google Chrome, etc…
            <br></br>Les mentions légales ont été générées sur le site
            <a
            ...
            met en œuvre tous les moyens dont il dispose, pour assurer une
            ...
            devra donc s'assurer de l'exactitude des informations et signaler
            toutes modifications du site qu'il jugerait utile.La société
            TRACER-O n'est en aucun cas responsable de l'utilisation faite de
            ces informations, et de tout préjudice direct ou indirect pouvant en
            découler.
            <br></br>
            <b>Cookies</b> : Le site{" "}
            <a href="http://www.tracer-o.fr">www.tracer-o.fr</a> peut-être amené
            à vous demander l’acceptation des cookies pour des besoins de
            statistiques et d'affichage. Un cookies est une information déposée
            sur votre disque dur par le serveur du site que vous visitez. Il
            ...
            disponibles sur Internet. Le webmaster ne dispose d'aucun moyen pour
            contrôler les sites en connexion avec ce site internet, ne répond
            pas de la disponibilité de tels sites et sources externes, ni ne la
            garantit. Elle ne peut être tenue pour responsable de tout dommage,
            de quelque nature que ce soit, résultant du contenu de ces sites ou
            sources externes, et notamment des informations, produits ou
            services qu’ils proposent, ou de tout usage qui peut être fait de
            ...
            d'utilisation. Les utilisateurs, les abonnés et les visiteurs des
            sites internet de ne peuvent mettre en place un hyperlien en
            direction de ce site sans l'autorisation expresse et préalable de
            Stéphane LAVAUD. Dans l'hypothèse où un utilisateur ou visiteur
            souhaiterait mettre en place un hyperlien en direction d’un des
            sites internet de Stéphane LAVAUD, il lui appartiendra d'adresser un
            email accessible sur le site afin de formuler sa demande de mise en
            place d'un hyperlien. Stéphane LAVAUD se réserve le droit d’accepter
            ...
            <p style={{ color: "#323333" }}>
                Le webmaster s’efforce de fournir sur le site www.tracer-o.fr
                des informations aussi précises que possible. les renseignements
                figurant sur le site{" "}
                <a href="http://www.tracer-o.fr">www.tracer-o.fr</a> ne sont pas
            ...
            l’adresse webmaster@tracer-o.fr, en décrivant le problème de la
            ...
            Internet ne sauraient engager la responsabilité du webmaster.
            <p style={{ color: "#b51a00" }}>
                <span style={{ color: "rgb(0, 0, 0)" }}>
            ...
            <a href="http://www.tracer-o.fr">www.tracer-o.fr</a>, incluant, de
            ...
            la société TRACER-O. Cette représentation ou reproduction, par
            ...
            <a href="http://www.tracer-o.fr">www.tracer-o.fr</a> sont régies par
            ...
            <a href="http://www.tracer-o.fr">www.tracer-o.fr</a>. Cependant, ce
            principe comporte certaines exceptions. En effet, pour certains
            ...
            société, ou de recevoir les lettres d’information. Enfin, nous
