...
class CotationForm extends React.Component {
    ...
    render() {
        const { name, email, message, phone, cargoDimensions, cargoKind, cargoWeight} = this.state;
        return (
        <Row >
                <h3 className="col-10 offset-1 text-center my-3">Confirmez votre demande de devis</h3>
            <Row >
                <Col xl={10} className="justify-content-center my-2 offset-1">
                    <Form onSubmit={this.handleSubmit} className="justify-content-center">
                        <FormGroup row>
                        <Label className="col-5 offset-1">
                        ...
                        <Label className="col-5 offset-3">
                            Téléphone: <Input type="text" name="phone" value={phone} valid={phone.length>=10 ? true : false} required onChange={this.handleChange} />
                        </Label>
                        <Label className="col-5 offset-1">
                            Nature de la marchandise: <Input type="text" name="cargoKind" value={cargoKind} required onChange={this.handleChange} />
                        </Label>
                        <Label className="col-5">
                            Poids de la marchandise: <Input type="text" name="cargoWeight" value={cargoWeight} required onChange={this.handleChange} />
                        </Label>
                        <Label className="col-5 offset-3">
                            Dimension de la marchandise: <Input type="text" name="cargoDimensions" value={cargoDimensions} required onChange={this.handleChange} />
                        </Label>
                        <Label className="col-10 offset-1">
