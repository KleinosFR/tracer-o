...
import {
  Row, Col, Form, Label, Input, FormGroup, Button
} from 'reactstrap';
...
class CotationForm extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    fetch('/', {
      ...
      .then(() => toast.success(
        <Col>
          Votre demande de devis a bien été envoyée, nous vous répondrons dans les plus brefs
          délais
        </Col>,
        {
          position: 'top-right',
      ...
      .catch((error) => toast.error(
        <Col>
          Votre demande n'a pas pu être envoyée. Veuillez essayer un peu plus tard, ou nous
  ...
  render() {
    const {
      name, email, message, phone, cargoDimensions, cargoKind
    } = this.state;
    return (
      <Row>
        ...
        <Row>
          <Col xl={10} xs={10} className="justify-content-center my-2 offset-1">
